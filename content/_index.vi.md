...
#### Chúng ta sẽ thực hiện mô hình tích hợp API Fan-out và lọc tin nhắn.

Là khách hàng đã đăng ký, khi bạn cần một chuyến đi, bạn có thể sử dụng ứng dụng khách hàng Wild Rydes để yêu cầu một con kỳ lân và quản lý nó. Là một kỳ lân đã đăng ký, bạn có thể sử dụng ứng dụng kỳ lân Wild Rydes để quản lý mọi thứ xung quanh doanh nghiệp của mình.
...
{{% notice tip %}}
Bài thực hành này sẽ tiếp nối câu chuyện của bài thực hành [Xây dựng serverless web app Wild Rydes](https://000036.awsstudygroup.com/vi)
{{% /notice %}}
...
3. [Sử dụng SAM triển khai hạ tầng](3-initstate/)
4. [Tạo Amazon SNS Topic](4-createsnstopic/)
5. [Tạo Customer notification](5-createcnss/)
6. [Tạo Customer accounting service](6-create/)
7. [Tạo Extraordinary rides service](7-create/)
8. [Cập nhật Unicorn Management Service](8-update/)
9. [Kiểm tra Fan-out và lọc tin nhắn](9-test/)
